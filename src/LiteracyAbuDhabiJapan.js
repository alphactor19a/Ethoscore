...
function LiteracyAbuDhabiJapan({ onNavigate }) {
            ...
            <div style={{width: 528, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex', gap: 24}}>
              ...
              <div style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 12, display: 'inline-flex'}}>
                <div style={{paddingLeft: 8, paddingRight: 8, paddingTop: 2, paddingBottom: 2, background: '#d4edda', borderRadius: 4, justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
                  <div style={{color: '#1C1917', fontSize: 12, fontFamily: 'Klim Type Foundry', fontWeight: '400', lineHeight: '18px'}}>Neutral • 1.7</div>
                </div>
                <div style={{paddingLeft: 8, paddingRight: 8, paddingTop: 2, paddingBottom: 2, background: '#E7E5E4', borderRadius: 4, justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
                  <div style={{color: '#1C1917', fontSize: 12, fontFamily: 'Klim Type Foundry', fontWeight: '400', lineHeight: '18px'}}>The National · Case Study</div>
                </div>
              </div>

              <div style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 8, display: 'flex'}}>
                <div style={{alignSelf: 'stretch', color: '#292524', fontSize: 40.7, fontFamily: 'Klim Type Foundry', fontWeight: '550', lineHeight: '48px'}}>Abu Dhabi to forge stronger investment ties with Japan as free trade deal talks progress</div>
              ...
              {viewMode === 'source' ? (
                <>
                  ...
                  <div style={{alignSelf: 'stretch', flexDirection: 'column', gap: 20, display: 'flex', color: '#1C1917', fontSize: 18, fontFamily: 'Klim Type Foundry', fontWeight: '400', lineHeight: '30px'}}>
                    <p style={{margin: 0}}>Abu Dhabi officials met with Japanese counterparts this week to discuss expanding bilateral investment as negotiations for a UAE-Japan free trade agreement continue.</p>
                    <p style={{margin: 0}}>The discussions focused on opportunities in technology, renewable energy, and infrastructure. Both sides expressed interest in deepening economic cooperation.</p>
                    <p style={{margin: 0, paddingLeft: 20, borderLeft: '3px solid #E7E5E4', fontStyle: 'italic', color: '#44403C'}}>"We see significant potential for collaboration across multiple sectors," said an Abu Dhabi Investment Office representative.</p>
                    <div style={{color: '#1C1917', fontSize: 22, fontFamily: 'Klim Type Foundry', fontWeight: '500', lineHeight: '28px', marginTop: 12, marginBottom: 4}}>Trade Negotiations</div>
                    <p style={{margin: 0}}>The free trade agreement talks, which began in 2023, aim to reduce tariffs and facilitate investment flows between the two economies.</p>
                    <p style={{margin: 0}}>Japan is currently the UAE's fourth-largest trading partner, with bilateral trade valued at approximately $35 billion annually.</p>
                    <div style={{color: '#1C1917', fontSize: 22, fontFamily: 'Klim Type Foundry', fontWeight: '500', lineHeight: '28px', marginTop: 12, marginBottom: 4}}>Investment Focus</div>
                    <p style={{margin: 0}}>Abu Dhabi's sovereign wealth funds have increased their Japanese holdings in recent years, with particular interest in technology and healthcare sectors.</p>
                  </div>
                </>
              ) : (
                <div style={{alignSelf: 'stretch', flexDirection: 'column', gap: 32, display: 'flex'}}>
                  <div style={{alignSelf: 'stretch', padding: 24, background: '#FAFAF9', borderRadius: 12, border: '1px solid #E5E7EB', flexDirection: 'column', gap: 20, display: 'flex'}}>
                    ...
                    <div style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', display: 'flex'}}>
                      ...
                      <div style={{color: '#16a34a', fontSize: 32, fontFamily: 'Klim Type Foundry', fontWeight: '600'}}>1.7/10</div>
                    </div>
                    <div style={{width: '100%', height: 8, background: '#E7E5E4', borderRadius: 4, overflow: 'hidden'}}><div style={{width: '17%', height: '100%', background: '#16a34a', borderRadius: 4}} /></div>
                    <div style={{color: '#1C1917', fontSize: 16, fontFamily: 'Klim Type Foundry', lineHeight: '24px'}}>This article presents trade and investment news with factual framing, using official sources and specific data points.</div>
                  </div>
                  ...
                  <div style={{alignSelf: 'stretch', flexDirection: 'column', gap: 12, display: 'flex'}}>
                    ...
                    <div style={{color: '#1C1917', fontSize: 18, fontFamily: 'Klim Type Foundry', lineHeight: '30px'}}>The headline describes diplomatic and economic developments factually. "Forge stronger ties" is mildly positive but reflects official framing of such meetings.</div>
                  </div>

                  <div style={{alignSelf: 'stretch', flexDirection: 'column', gap: 12, display: 'flex'}}>
                    <div style={{color: '#1C1917', fontSize: 20, fontFamily: 'Klim Type Foundry', fontWeight: '500'}}>Framing Strategy</div>
                    <div style={{color: '#1C1917', fontSize: 18, fontFamily: 'Klim Type Foundry', lineHeight: '30px'}}>The article employs a <strong>diplomatic/business</strong> frame:</div>
                    <ul style={{color: '#1C1917', fontSize: 18, fontFamily: 'Klim Type Foundry', lineHeight: '30px', paddingLeft: 24, margin: 0}}>
                      <li style={{marginBottom: 8}}>Reports meeting outcomes factually</li>
                      <li style={{marginBottom: 8}}>Uses official sources</li>
                      <li style={{marginBottom: 8}}>Provides trade data context</li>
                      <li style={{marginBottom: 8}}>Notes specific sectors of interest</li>
                    </ul>
                  </div>
                  ...
                  <div style={{alignSelf: 'stretch', flexDirection: 'column', gap: 16, display: 'flex'}}>
                    ...
                    {[
                      { term: '"met with counterparts"', desc: 'Standard diplomatic language without embellishment.' },
                      { term: '"expressed interest"', desc: 'Reports stated intentions without overstating.' },
                      { term: '"aim to reduce"', desc: 'Describes negotiation goals factually.' },
                      { term: '"valued at approximately"', desc: 'Provides specific data with appropriate qualification.' },
                      { term: '"particular interest in"', desc: 'Notes focus areas without promotional language.' }
                    ].map((item, i) => (
                  ...
                  <div style={{alignSelf: 'stretch', flexDirection: 'column', gap: 16, display: 'flex'}}>
                    ...
                    <div style={{flexDirection: 'row', flexWrap: 'wrap', gap: 10, display: 'flex'}}>
                      {['diplomatic framing', 'data citation', 'official sourcing', 'sector specificity', 'factual reporting'].map((tag, i) => (
                  ...
                  <div style={{alignSelf: 'stretch', flexDirection: 'column', gap: 12, display: 'flex'}}>
                    ...
                    <div style={{padding: 20, background: '#FAFAF9', borderRadius: 8, border: '1px solid #E5E7EB'}}>
                      ...
                      <ul style={{color: '#1C1917', fontSize: 18, fontFamily: 'Klim Type Foundry', lineHeight: '30px', paddingLeft: 24, margin: 0}}>
                        <li style={{marginBottom: 8}}>Factual reporting of diplomatic meetings</li>
                        <li style={{marginBottom: 8}}>Specific trade figures provided</li>
                        <li style={{marginBottom: 8}}>Official sources cited</li>
                        <li style={{marginBottom: 8}}>No promotional or critical framing</li>
                        <li style={{marginBottom: 8}}>Context on negotiation timeline</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div style={{alignSelf: 'stretch', padding: 24, background: '#d4edda', borderRadius: 12, border: '1px solid #c3e6cb', flexDirection: 'column', gap: 16, display: 'flex'}}>
                    ...
                    <div style={{color: '#1C1917', fontSize: 18, fontFamily: 'Klim Type Foundry', lineHeight: '30px'}}>This article exemplifies standard business and diplomatic journalism. It reports developments factually with appropriate data and official sources.</div>
                    <div style={{color: '#1C1917', fontSize: 18, fontFamily: 'Klim Type Foundry', lineHeight: '30px', marginTop: 16}}><strong>Reader Note:</strong> Business journalism often reflects official framing. This piece stays close to facts without excessive promotion or criticism.</div>
                  </div>
                  ...
                  <div style={{alignSelf: 'stretch', flexDirection: 'column', gap: 12, display: 'flex', marginTop: 16}}>
                    ...
                    <div style={{color: '#1C1917', fontSize: 18, fontFamily: 'Klim Type Foundry', lineHeight: '30px'}}>Business and diplomatic journalism typically uses official sources and specific data. Watch for promotional framing versus factual reporting.</div>
            ...
            <div style={{width: 280, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 24, display: 'flex', position: 'sticky', top: 24}}>
              <div style={{alignSelf: 'stretch', padding: 20, background: '#FAFAF9', borderRadius: 12, border: '1px solid #E5E7EB', flexDirection: 'column', gap: 16, display: 'flex'}}>
                ...
                <div style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', display: 'flex'}}>
                  ...
                  <div style={{color: '#16a34a', fontSize: 24, fontFamily: 'Klim Type Foundry', fontWeight: '600'}}>1.7/10</div>
                </div>
                <div style={{width: '100%', height: 6, background: '#E7E5E4', borderRadius: 3, overflow: 'hidden'}}><div style={{width: '17%', height: '100%', background: '#16a34a', borderRadius: 3}} /></div>
...
export default LiteracyAbuDhabiJapan;
